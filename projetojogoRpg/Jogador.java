...
public class Jogador {
   ...
   // private int poder_ataque; //tirar ou implementar
    ...
    public Jogador(String nome){ // nome jogador é digitada pelo usuário - esse construtor é usado pra criar Guerreira e Maga
        this.nome = nome;
    ...
    public String avatar(String[] lstAvatar){ //retorna o avatar escolhido pro personagem
        int escolha, i;
        do{
